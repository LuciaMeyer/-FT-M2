...
// 1- Está usando el módulo EventEmitter
var EvEm = require('./event-emitter.js');

// 2- Está exponiendo la variable whiteboard en objeto global para ser usado por otros
var whiteboard = new EvEm();
